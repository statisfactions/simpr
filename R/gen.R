...
#'
#' Use specification from \code{\link{variables}} or \code{\link{meta}} to
...
#' the simulation in  \code{\link{variables}} and \code{\link{meta}}.
#'
#' @param x a \code{simpr_spec} object generated by \code{\link{variables}} or
...
#' @seealso \code{\link{variables}} and \code{\link{meta}} for examples of how
...
#'  ## rows in the output
#'  meta_list_2 = variables(x = ~ MASS::mvrnorm(n, rep(0, 2), Sigma = S)) %>%
#'   meta(n = c(10, 20, 30),
#'        S = list(independent = diag(2), correlated = diag(2) + 2)) %>%
#'   gen(4)
#'
