...
#' (generated by \code{\link{blueprint}} and
#' \code{\link{meta}}) which are simply stored for
#' later evaluation by \code{\link{produce_sims}},
#' and one for \code{\link{simpr_sims}}
#' objects to perform the operation elementwise on
#' each simulation.  If you do NOT want to compute
#' only on each simulation but want to operate on
#' the entire simulation tibble, use
#' \code{\link{as_tibble}}.
