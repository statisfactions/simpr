...
-   **Take care of the housekeeping.** `simpr` takes care of all the
    details of generating your simulation across varying parameters,
    without the need for nested `for` loops or the `lapply` family of
    functions.

-   **Specify the data generating mechanism inline.** You can specify
