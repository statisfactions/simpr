...
A common use case is for regenrating the data in cases where an error was created.  Here's an example of a simulation that only generated errors in one condition. We generate some data and fit a logistic regression, but notice that we get some errors.
